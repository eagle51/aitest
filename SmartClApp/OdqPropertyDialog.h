...
public:
  ...
  void addColor(const QString& qsColor);
  QColor getQColor();
  void updateSelection();

  static QColor toQColor(const class OdCmEntityColor& color);
  static QIcon createIcon(const QString& sPacked);
...
public:
  ...
  static OdCmEntityColor OdColorByString(const QString& qsColor, bool* pIsOk = NULL);
