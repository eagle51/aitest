...
///////////////////////////////////////////////////////////////////////////////
  ...
  // it's here to prevent impossible linking with SmartClApp :
...
static bool perspective_value(OdRxObject* pRxDb)
{
  ...
  if (pDb.get())
    ...
    bVal = pExtDb->isPerspective(pRxDb);
  return bVal;
}
...
void initOdSysVarPE()
{
  ...
  if (s_bUnlinkedWithPropServices)
  {
    ...
    // (to prevent impossible linking with SmartClApp)
